            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card-style">
                        <form action="{{ route('admin.feature-highlights.store') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="image-wrapper border-red-500 cursor-pointer">
                                        <label for="image_input">
                                            ...
                                            <img id="image-preview" class="img-fluid cursor-pointer"
                                                src="{{ getPlaceholderImage(488, 240) }}" loading="lazy"
                                                alt="your image" />
                                        </label>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reset_image').click(function() {
                $('#image-preview').attr('src', "{{ getPlaceholderImage(488, 240) }}");
                $('#image_input').val('');
                $('#image').val('');
            });
        })
