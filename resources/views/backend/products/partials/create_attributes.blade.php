                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-6 my-1">
                                        ...
                                        <x-input-group :type="'text'" :name="'name_attr[]'" :placeholder="'Enter attribute name'"
                                            :class="'name_attr'" :value="$old_name_attr">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col my-1">
                                                    ...
                                                    <x-input-group :type="'text'" :name="'item_name_attr_' . $key . '[]'"
                                                        :value="$item" :style="'padding:10px'" :placeholder="'Enter name'"
                                                ...
                                                <div class="col  my-1">
                                                    ...
                                                    <x-input-group :type="'number'" :step="'any'"
                                                        :value="old('price_adjustment_attr_' . $key)[$index] ?? ''" :style="'padding:10px'" :name="'price_adjustment_attr_' . $key . '[]'"
                                                ...
                                                <div class="col  my-1">
                                                    ...
                                                    <x-input-group :type="'text'" :style="'padding:10px'"
                                                        :value="old('code_attr_' . $key)[$index] ?? ''" :name="'code_attr_' . $key . '[]'" :placeholder="'Enter code'"
                                                        :class="'codesAttr'">
                                                    </x-input-group>
                                                </div>
                                            </div>
