                        ...
                        <div class="breadcrumb-wrapper">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item ">
                                        <a href="{{ route('admin.category.index') }}">{{ __('app.categories') }}</a>
                                    </li>
                        ...
                        <form action="{{ route('admin.category.update', $category->slug) }}" method="post"
                            ...
                            <div class="row">
                                <div class="col-md-12 my-2">
                                    ...
                                    <x-input-group :type="'text'" :value="old('name', $category->name)" :name="'name'" :placeholder="__('app.enter_title_of_category')"
                                        :id="'name'">
                                    ...
                                    <div class="image-wrapper border-red-500 cursor-pointer">
                                        <label for="image_input">
                                            ...
                                            <img id="image-preview" class="img-fluid cursor-pointer"
                                                src="{{ asset($category->image) }}" alt="preview_img" />
                                        </label>
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#reset_image').click(function() {
                $('#image_input').val('');
                $('#image-preview').attr('src', '{{ asset($category->image) }}');
                $('#image').val('');
            });
        });
    </script>
