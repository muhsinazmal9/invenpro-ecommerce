                        ...
                        <form action="{{ route('admin.addresses.store',$user->username) }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-md-12 my-2">
                                    ...
                                    <x-input-group :type="'text'" :value="old('title')" :name="'title'" :placeholder="__('app.title')"
                                        :id="'title'">
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'text'" :value="old('customer_name')" :name="'customer_name'" :placeholder="__('app.customer_name')"
                                        :id="'customer_name'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('customer_name')
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'text'" :value="old('email')" :name="'email'" :placeholder="__('app.email')"
                                        :id="'email'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('email')
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'tel'" :value="old('phone')" :name="'phone'" :placeholder="__('app.phone')"
                                        :id="'phone'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('phone')
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'text'" :value="old('street_address')" :name="'street_address'" :placeholder="__('app.street_address')"
                                        :id="'street_address'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'apt_or_floor'" :value="old('apt_or_floor')" :name="'apt_or_floor'" :placeholder="__('app.apt_floor_suite_etc')" :id="'apt_or_floor'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('apt_or_floor')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'zip_code'" :value="old('zip_code')" :name="'zip_code'" :placeholder="__('app.zip_code')" :id="'zip_code'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('zip_code')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'city'" :value="old('city')" :name="'city'" :placeholder="__('app.city')" :id="'city'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('city')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'country'" :value="old('country')" :name="'country'" :placeholder="__('app.country')" :id="'country'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('country')
                                        <span class="text-danger">{{ $message }}</span>
                                ...
                                <div class="col-md-6 my-2">
                                    ...
                                    <x-input-group :type="'text'" :value="old('coordinate')" :name="'coordinate'" :placeholder="__('app.coordinate')"
                                        :id="'coordinate'">
                                        <span class="mdi mdi-shape"></span>
                                    </x-input-group>
                                    @error('coordinate')
