...
<head>
    ...
    <style media="screen and (min-width:480px)">
        .moz-text-html .column-per-100 {
            width: 100% !important;
            max-width: 100%;
        }

        .moz-text-html .column-per-50 {
            width: 50% !important;
            max-width: 50%;
        }
    </style>
...
<body style="word-spacing:normal;">
    <div style="">
                ...
                <tbody>
                    <tr>
                        <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;">
                            <div class="column-per-100 mj-outlook-group-fix"
                                    ...
                                    <tbody>
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            <td style="width:100px;">
                                                                <img height="auto"
                                                                    src="{{ public_path(getSetting('primary_logo')) }}"
                                        ...
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Roboto;font-size:32px;font-weight:bold;line-height:2;text-align:center;color:#3E4040;">
                                                    Order Approved  #{{ $order->invoice_id }}</div>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="center"
                                        ...
                                        <tr>
                                            <td align="center"
                                                style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                <div
                                                    style="font-family:Roboto;font-size:14px;font-weight:bold;line-height:1;text-align:center;color:#3E4040;">
                                                    <p>Hi, {{ $user->fname }}</p>
                                                    <p>Your order {{ $order->invoice_id }} has been approved</p>
        ...
        @include('mail.partials.summery')
        @include('mail.partials.call_to_action')
    </div>
</body>
