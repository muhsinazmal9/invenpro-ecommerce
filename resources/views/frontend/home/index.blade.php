...
<head>
    <meta charset="utf-8">
    <title>InvenPro - Multipurpose eCommerce</title>
                        ...
                        <div class="topbar-center marquee-wrapper">
                            <div class="initial-child-container">
                                <div class="marquee-child-item">
                                    <p>🔔📢 Stay Tuned for Our Mega Sale – Exciting Deals Coming Soon!</p>
                                </div>
                                <div class="marquee-child-item"><span class="dot"></span></div>
                                <div class="marquee-child-item">
                                    <p>🚚✨ Free Shipping on All Orders Across Dhaka! Shop Now!</p>
                                </div>
                                <div class="marquee-child-item"><span class="dot"></span></div>
                                <div class="marquee-child-item">
                                    <p>Order Now! 🚀</p>
                            ...
                            <div class="header-language">
                                ...
                                <!-- <div class="tf-currencies">
                                    <select class="image-select center style-default type-currencies">
                                        <option selected data-thumbnail="{{ asset('front_assets/images') }}/country/us.png">United States (USD $)
                                        </option>
                                        <option data-thumbnail="{{ asset('front_assets/images') }}/country/fr.png">France (EUR €)</option>
                                        <option data-thumbnail="{{ asset('front_assets/images') }}/country/ger.png">Germany (EUR €)</option>
                                        <option data-thumbnail="{{ asset('front_assets/images') }}/country/vn.png">Vietnam (VND ₫)</option>
                                    </select>
                                </div> -->
                            </div>
                        </div>
                                    ...
                                    <div class="row-demo">
                                        <div class="demo-item">
                                            <a href="index.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/fashion-1.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/fashion-1.jpg" alt="home-fashion">
                                        ...
                                        <div class="demo-item">
                                            <a href="home-fashion-02.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/fashion-2.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/fashion-2.jpg" alt="home-fashion">
                                            </a>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-electronic.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/electronic.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/electronic.jpg" alt="home-electronic">
                                            </a>
                                            </a>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-furniture.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/furniture.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/furniture.jpg" alt="home-furniture">
                                            </a>
                                            <a href="home-furniture.html" class="demo-name link">Furniture</a>
                                        </div>
                                        <div class="demo-item">
                                            <a href="home-fashion-women.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/women-fashion.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/women-fashion.jpg" alt="home-women-fashion">
                                                <div class="demo-label">
                                                    <span>New</span>
                                                    <span class="demo-hot">Hot</span>
                                                </div>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-skincare.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/comestic.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/comestic.jpg" alt="home-comestic">
                                            </a>
                                            <a href="home-skincare.html" class="demo-name link">Skincare</a>
                                        </div>
                                        <div class="demo-item">
                                            <a href="home-bicycle.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/bicycle.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/bicycle.jpg" alt="home-bicycle">
                                            </a>
                                            <a href="home-bicycle.html" class="demo-name link">Bicycle</a>
                                        </div>
                                        <div class="demo-item">
                                            <a href="home-phonecase.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/phonecase.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/phonecase.jpg" alt="home-phonecase">
                                            </a>
                                            <a href="home-phonecase.html" class="demo-name link">Phone Case</a>
                                        </div>
                                        <div class="demo-item">
                                            <a href="home-pet-accessories.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/pet-accessories.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/pet-accessories.jpg" alt="home-pet">
                                            </a>
                                        ...
                                        <div class="demo-item">
                                            <a href="home-sportwear.html" class="demo-image">
                                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/sportwear.jpg"
                                                    src="{{ asset('front_assets/images') }}/demo/sportwear.jpg" alt="home-sportwear">
                                            </a>
                                        ...
                                        <div dir="ltr" class="swiper tf-swiper hover-sw-nav wow fadeInUp" data-swiper='{
                                            ...
                                            <div class="swiper-wrapper">
                                                <div class="swiper-slide">
                                                    <div class="wg-cls style-abs bg-surface asp-1 hover-img">
                                                        <a href="shop-default.html" class="image img-style d-block">
                                                            <img src="{{ asset('front_assets/images') }}/cls-categories/electronic/smartphone.png"
                                                                data-src="{{ asset('front_assets/images') }}/cls-categories/electronic/smartphone.png"
                                                                alt="" class="lazyload">
                                                        </a>
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="wg-cls style-abs bg-surface asp-1 hover-img">
                                                        <a href="shop-default.html" class="image img-style d-block">
                                                            <img src="{{ asset('front_assets/images') }}/cls-categories/electronic/earphone.png"
                                                                data-src="{{ asset('front_assets/images') }}/cls-categories/electronic/earphone.png"
                                                                alt="" class="lazyload">
                                                        </a>
                                                        <div class="cls-btn text-center">
                                                            <a href="shop-default.html"
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="wg-cls style-abs bg-surface asp-1 hover-img">
                                                        <a href="shop-default.html" class="image img-style d-block">
                                                            <img src="{{ asset('front_assets/images') }}/cls-categories/electronic/cable.png"
                                                                data-src="{{ asset('front_assets/images') }}/cls-categories/electronic/cable.png"
                                                                alt="" class="lazyload">
                                                        </a>
                                                        <div class="cls-btn text-center">
                                                            <a href="shop-default.html"
                                                ...
                                                <div class="swiper-slide">
                                                    <div class="wg-cls style-abs bg-surface asp-1 hover-img">
                                                        <a href="shop-default.html" class="image img-style d-block">
                                                            <img src="{{ asset('front_assets/images') }}/cls-categories/electronic/headphone.png"
                                                                data-src="{{ asset('front_assets/images') }}/cls-categories/electronic/headphone.png"
                                                                alt="" class="lazyload">
                                                        </a>
                                                        <div class="cls-btn text-center">
                                                            <a href="shop-default.html"
                                                        ...
                                                        <div class="card-product-wrapper">
                                                            <a href="product-detail.html" class="product-img">
                                                                <img class="img-product lazyload"
                                                                    ...
                                                                    src="{{ asset('front_assets/images') }}/products/electronic/ss-s21.jpg"
                                                                    alt="image-product">
                                                                <img class="img-hover lazyload"
                                ...
                                <div class="sub-menu sub-menu-style-2">
                                    ...
                                    <div class="banner hover-img">
                                        <a href="blog-single.html" class="img-style">
                                            <img src="{{ asset('front_assets/images') }}/blog/banner-header.jpg" alt="banner">
                                        </a>
                                        <div class="content">
                                            <div class="title">
                                        ...
                                        <ul class="list-recent-blog">
                                            <li class="item">
                                                <a href="blog-single.html" class="img-box">
                                                    <img src="{{ asset('front_assets/images') }}/blog/recent-1.jpg" alt="img-recent-blog">
                                                </a>
                                                <div class="content">
                                            ...
                                            <li class="item">
                                                <a href="blog-single.html" class="img-box">
                                                    <img src="{{ asset('front_assets/images') }}/blog/recent-2.jpg" alt="img-recent-blog">
                                                </a>
                                                <div class="content">
                                            ...
                                            <li class="item">
                                                <a href="blog-single.html" class="img-box">
                                                    <img src="{{ asset('front_assets/images') }}/blog/recent-3.jpg" alt="img-recent-blog">
                                                </a>
                                                <div class="content">
...
Smart Watch & Audio -->
                                ...
                                {{-- <div class="swiper-slide">
                                    <div class="wg-cls style-square hover-img">
                                        <a href="shop-sub-collection.html" class="image img-style d-block">
                                            <img src="{{ asset('front_assets/images') }}/cls-categories/electronic/smartphone.png"
                                                data-src="{{ asset('front_assets/images') }}/cls-categories/electronic/smartphone.png" alt="cls"
                                                class="lazyload">
                                        </a>
                    ...
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="brand-item wow fadeInLeft">
                                <img src="{{ asset('front_assets/images') }}/brand/zara.png" alt="brand">
                            </div>
                        </div>
                        <!-- item 2 -->
                        <div class="swiper-slide">
                            <div class="brand-item wow fadeInLeft" data-wow-delay="0.1s">
                                <img src="{{ asset('front_assets/images') }}/brand/bear.png" alt="brand">
                            </div>
                        </div>
                        <!-- item 3 -->
                        <div class="swiper-slide">
                            <div class="brand-item wow fadeInLeft" data-wow-delay="0.2s">
                                <img src="{{ asset('front_assets/images') }}/brand/nike.png" alt="brand">
                            </div>
                        </div>
                        <!-- item 4 -->
                        <div class="swiper-slide">
                            <div class="brand-item wow fadeInLeft" data-wow-delay="0.3s">
                                <img src="{{ asset('front_assets/images') }}/brand/asos.png" alt="brand">
                            </div>
                        </div>
                        <!-- item 5 -->
                        <div class="swiper-slide">
                            <div class="brand-item wow fadeInLeft" data-wow-delay="0.4s">
                                <img src="{{ asset('front_assets/images') }}/brand/burberry.png" alt="brand">
                            </div>
                        </div>
                        <!-- item 6 -->
                        <div class="swiper-slide">
                            <div class="brand-item wow fadeInLeft" data-wow-delay="0.5s">
                                <img src="{{ asset('front_assets/images') }}/brand/forever.png" alt="brand">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="swiper-wrapper">
                            ...
                            <div class="swiper-slide">
                                <div class="blog-item-v2">
                                    <div class="entry-image hover-img">
                                        <a href="blog-single.html" class="img-style">
                                            <img src="{{ asset('front_assets/images') }}/blog/blog-eletric1.jpg"
                                                data-src="{{ asset('front_assets/images') }}/blog/blog-eletric1.jpg" alt="image">
                                        </a>
                                        <div class="entry-tag">
                            ...
                            <div class="swiper-slide">
                                <div class="blog-item-v2">
                                    <div class="entry-image hover-img">
                                        <a href="blog-single.html" class="img-style">
                                            <img src="{{ asset('front_assets/images') }}/blog/blog-eletric2.jpg"
                                                data-src="{{ asset('front_assets/images') }}/blog/blog-eletric2.jpg" alt="image">
                                        </a>
                                        <div class="entry-tag">
                            ...
                            <div class="swiper-slide">
                                <div class="blog-item-v2">
                                    <div class="entry-image hover-img">
                                        <a href="blog-single.html" class="img-style">
                                            <img src="{{ asset('front_assets/images') }}/blog/blog-eletric3.jpg"
                                                data-src="{{ asset('front_assets/images') }}/blog/blog-eletric3.jpg" alt="image">
                                        </a>
                                        <div class="entry-tag">
                    ...
                    <div class="footer-top-wrap">
                        <div class="footer-logo">
                            <a href="home-electronic.html">
                                <img src="{{ asset('front_assets/images') }}/logo/logo.svg" class="logo" alt="logo">
                            </a>
                        </div>
                                ...
                                <div class="footer-contact">
                                    <ul class="footer-info">
                                        <li class="item">
                                            ...
                                            <a target="_blank"
                                                href="https://www.google.com/maps/search/House+7+Road+4+Dhanmondi+Dhaka+1205+Bangladesh/@23.7413025,90.3825802,17z?entry=s&sa=X">
            ...
            <div class="footer-bottom">
                <div class="container">
                    <div class="footer-bottom-wrap">
                        <p class="text-dark">Copyright © 2025 by <span class="fw-medium">InvenPro.</span> All Rights
                            Reserved.</p>
                        <ul class="tf-payment">
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/EximBank.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/ApplePay.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/DinersClub.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/Discover.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/GooglePay.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/Mastercard-2.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/Mastercard.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/Shop.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/UnionPay.png" alt="payment"></li>
                            <li class="item"><img src="{{ asset('front_assets/images') }}/payment/Visa.png" alt="payment"></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="mega-menu">
                    <div class="row-demo">
                        ...
                        <div class="demo-item">
                            <a href="home-skincare.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/comestic.jpg" src="{{ asset('front_assets/images') }}/demo/comestic.jpg"
                                    alt="home-comestic">
                            </a>
                            <a href="home-skincare.html" class="demo-name link">Skincare</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-bicycle.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/bicycle.jpg" src="{{ asset('front_assets/images') }}/demo/bicycle.jpg"
                                    alt="home-bicycle">
                        ...
                        <div class="demo-item">
                            <a href="home-sportwear.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/sportwear.jpg"
                                    src="{{ asset('front_assets/images') }}/demo/sportwear.jpg" alt="home-bicycle">
                            </a>
                            <a href="home-sportwear.html" class="demo-name link">Sportwear</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-jewelry.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/jewelry.jpg" src="{{ asset('front_assets/images') }}/demo/jewelry.jpg"
                                    alt="home-jewelry">
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-electric-accessories.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/eletric-accessories.jpg"
                                    src="{{ asset('front_assets/images') }}/demo/eletric-accessories.jpg" alt="home-electric-accessories">
                                <div class="demo-label">
                                    <span>New</span>
                                    <span class="demo-hot">Hot</span>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-mega-electronic.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/mega-shop.jpg"
                                    src="{{ asset('front_assets/images') }}/demo/mega-shop.jpg" alt="home-mega-electronic">
                            </a>
                            <a href="home-mega-electronic.html" class="demo-name link">Mega Shop</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-vegetable.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/supermarket.jpg"
                                    src="{{ asset('front_assets/images') }}/demo/supermarket.jpg" alt="home-supermarket">
                            </a>
                            <a href="home-vegetable.html" class="demo-name link">Supermarket</a>
                        </div>
                        <div class="demo-item">
                            <a href="home-pod.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/pod.jpg" src="{{ asset('front_assets/images') }}/demo/pod.jpg"
                                    alt="home-pod">
                            </a>
                        ...
                        <div class="demo-item">
                            <a href="home-baby.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/baby.jpg" src="{{ asset('front_assets/images') }}/demo/baby.jpg"
                                    alt="home-baby">
                                <div class="demo-label">
                                    <span>New</span>
                                </div>
                        ...
                        <div class="demo-item">
                            <a href="home-plant.html" class="demo-image">
                                <img class="lazyload" data-src="{{ asset('front_assets/images') }}/demo/plant.jpg" src="{{ asset('front_assets/images') }}/demo/plant.jpg"
                                    alt="home-plant">
                            </a>
        ...
        <div class="mb-canvas-content">
            ...
            <div class="mb-bottom">
                <div class="bottom-bar-language">
                    <div class="tf-currencies">
                        <select class="image-select center style-default type-currencies">
                            <option selected data-thumbnail="{{ asset('front_assets/images') }}/country/us.png">USD</option>
                            <option data-thumbnail="{{ asset('front_assets/images') }}/country/fr.png">EUR</option>
                            <option data-thumbnail="{{ asset('front_assets/images') }}/country/ger.png">EUR</option>
                            <option data-thumbnail="{{ asset('front_assets/images') }}/country/vn.png">VND</option>
                        </select>
                    </div>
                    <div class="tf-languages">
                        <select class="image-select center style-default type-languages">
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <a href="product-detail.html">
                                            <img class="lazyload"
                                                data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-black.jpg"
                                                src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-black.jpg" alt="img-product">
                                        </a>
                                    </div>
                                ...
                                <div class="tf-mini-cart-item file-delete">
                                    <div class="tf-mini-cart-image">
                                        <a href="product-detail.html">
                                            <img class="lazyload"
                                                data-src="{{ asset('front_assets/images') }}/products/electronic/ss-smart-watch.jpg"
                                                src="{{ asset('front_assets/images') }}/products/electronic/ss-smart-watch.jpg" alt="img-product">
                                        </a>
                                    </div>
                                    <div class="tf-mini-cart-info">
                                        <div class="d-flex justify-content-between">
                    ...
                    <div dir="ltr" class="swiper tf-single-slide">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide" data-color="black">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-black.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-black.jpg" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-color="red">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-red.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-red.jpg" alt="">
                                </div>
                            </div>
                            <div class="swiper-slide" data-color="pink">
                                <div class="item">
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-pink.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-pink.jpg" alt="">
                                </div>
                            </div>
                        </div>
                ...
                <div class="tf-product-info-wrap">
                    <div class="tf-product-info-inner">
                        <div class="tf-product-info-heading">
                            <h6 class="product-info-name"><a href="product-detail.html" class="link">Apple AirPods Pro 2
                ...
                <div class="main-product-quickadd card-product">
                    <div class="item-product-info">
                        <div class="product-img">
                            <img class="img-product lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-black.jpg"
                                src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-black.jpg" alt="image-product">
                        </div>
                        ...
                        <div class="quickadd-variant-color">
                            ...
                            <ul class="list-color-product">
                                ...
                                <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                    ...
                                    <span class="swatch-value bg-red-2"></span>
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-red.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-red.jpg" alt="image-product">
                                </li>
                                <li class="list-color-item color-swatch hover-tooltip tooltip-bot">
                                    <span class="tooltip color-label">Pink</span>
                                    <span class="swatch-value bg-light-pink-10"></span>
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-pink.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/airpod-pro-pink.jpg" alt="image-product">
                                </li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="tf-compare-inner">
                        <div class="tf-compare-list">
                            ...
                            <div class="tf-compare-item file-delete">
                                <span class="icon-close remove"></span>
                                <a href="product-detail.html" class="image">
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/earbuds2-black.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/earbuds2-black.jpg" alt="">
                                </a>
                                <div class="content">
                                    <div class="text-title">
                            ...
                            <div class="tf-compare-item file-delete">
                                <span class="icon-close remove"></span>
                                <a href="product-detail.html" class="image">
                                    <img class="lazyload" data-src="{{ asset('front_assets/images') }}/products/electronic/ss-smart-watch.jpg"
                                        src="{{ asset('front_assets/images') }}/products/electronic/ss-smart-watch.jpg" alt="">
                                </a>
                                <div class="content">
                                    <div class="text-title">
    ...
    <script src="{{ asset('front_assets/js') }}/carousel.js"></script>
    <script src="{{ asset('front_assets/js') }}/bootstrap-select.min.js"></script>
    <script src="{{ asset('front_assets/js') }}/lazysize.min.js"></script>
    <script src="{{ asset('front_assets/js') }}/count-down.js"></script>
    <script src="{{ asset('front_assets/js') }}/wow.min.js"></script>
    <script src="{{ asset('front_assets/js') }}/multiple-modal.js"></script>
